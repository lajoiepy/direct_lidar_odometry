...
def generate_launch_description():
	...
	pointcloud_topic_cfg = LaunchConfiguration('pointcloud_topic', default='/Carol/velodyne_points')
	...
	imu_topic_cfg = LaunchConfiguration('imu_topic', default = '/Carol/imu/data')
